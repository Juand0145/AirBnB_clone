...
class TestState(unittest.TestCase):
    '''Class to test the class State'''

    def test_init(self):
        '''Testing the creation of the class'''
        test = State()
        self.assertTrue(isinstance(test, State))
        ...
        self.assertTrue(isinstance(test_3, State))
    ...
    def test_str(self):
        ...
        str_test = "[State] ({})".format(test_1.id)
    ...
    def test_arguments(self):
        '''Funtion to test more arguments to the class State'''
