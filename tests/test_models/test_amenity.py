...
class TestAmenity(unittest.TestCase):
    '''Class to test the class Amenity'''
    ...
    def test_init(self):
        ...
        test_2 = Amenity(**test_dict)
        self.assertNotEqual(test_2.__class__, "Perro")

        test_dict = {}
        test_3 = Amenity(**test_dict)
        self.assertTrue(isinstance(test_3, Amenity))
    ...
    def test_str(self):
        ...
        str_test = "[Amenity] ({})".format(test_1.id)
    ...
    def test_arguments(self):
        '''Funtion to test more arguments to the class Amenity'''
