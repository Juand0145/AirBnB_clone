...
class TestReview(unittest.TestCase):
    '''Class to test the class Review'''

    def test_init(self):
        '''Testing the creation of the class'''
        test = Review()
        self.assertTrue(isinstance(test, Review))
    ...
    def test_str(self):
        ...
        str_test = "[Review] ({})".format(test_1.id)
    ...
    def test_arguments(self):
        '''Funtion to test more arguments to the class Review'''
